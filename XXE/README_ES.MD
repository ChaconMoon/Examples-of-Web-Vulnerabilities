...
Puedes enviar un fichero al sitio web usando el comando curl. En Windows, PowerShell interpreta `@` como operador, así que usa `curl.exe` y pon la ruta del archivo entre comillas.
